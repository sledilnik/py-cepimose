...
class CepimoseTestCase(unittest.TestCase):
    ...
    def test_vaccinations_by_day(self):
        ...
        assertRow(data[41], datetime.datetime(2021, 2, 6), 56066, 35817)
        assertRow(data[42], datetime.datetime(2021, 2, 7), 56066, 35817)
    ...
    def test_vaccinations_by_manufacturer_used(self):
        ...
        assertRow(data[23], datetime.datetime(2021, 1, 19), [1922, 66, None, None])
        assertRow(data[38], datetime.datetime(2021, 2, 3), [3939, None, 1, None])
    ...
    def test_vaccinations_in_range_by_age_group_by_gender(self):
        ...
        self.assertAlmostEqual(group90.female.dose2, 8272, delta=200)
