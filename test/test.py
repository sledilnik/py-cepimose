...
class CepimoseTestCase(unittest.TestCase):
    ...
    def test_vaccinations_by_day(self):
        ...
        assertRow(data[41], datetime.datetime(2021, 2, 6), 56066, 39185)
        assertRow(data[42], datetime.datetime(2021, 2, 7), 56066, 39185)
    ...
    def test_vaccinations_by_manufacturer_used(self):
        ...
        assertRow(data[38], datetime.datetime(2021, 2, 3), [4323, None, 1, None])
