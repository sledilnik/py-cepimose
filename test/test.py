...
class CepimoseTestCase(unittest.TestCase):
    ...
    def test_vaccinations_by_day(self):
        ...
        assertRow(data[41], datetime.datetime(2021, 2, 6), 56066, 32339)
        assertRow(data[42], datetime.datetime(2021, 2, 7), 56066, 32339)
    ...
    def test_vaccinations_by_manufacturer_used(self):
        ...
        assertRow(data[23], datetime.datetime(2021, 1, 19), [1714, 66, None, None])
        assertRow(data[38], datetime.datetime(2021, 2, 3), [3684, None, 1, None])
