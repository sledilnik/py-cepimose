...
class CepimoseTestCase(unittest.TestCase):
    ...
    def test_vaccinations_by_day(self):
        ...
        assertRow(data[41], datetime.datetime(2021, 2, 6), 56066, 42463)
        assertRow(data[42], datetime.datetime(2021, 2, 7), 56066, 42463)
    ...
    def test_vaccinations_by_manufacturer_used(self):
        ...
        assertRow(data[38], datetime.datetime(2021, 2, 3), [4550, None, 1, None])
    ...
    def test_vaccinations_in_range_by_age_group_by_gender(self):
        ...
        self.assertAlmostEqual(group90.female.dose1, 9062, delta=50)
        self.assertAlmostEqual(group90.female.dose2, 8360, delta=50)
        self.assertAlmostEqual(group90.male.dose1, 2969, delta=50)
        self.assertAlmostEqual(group90.male.dose2, 2809, delta=50)
